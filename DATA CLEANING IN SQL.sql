...
----Fill null values to 'Years_in_current_job' with mode value 
Select Years_in_current_job, count(Years_in_current_job) from credit_train
group by Years_in_current_job

UPDATE credit_train 
SET Years_in_current_job = '10+ years'
WHERE bankruptcies = 'n/a'
